...
const mobilityInfographicUrl = `${import.meta.env.BASE_URL}media/rapot-movilidad.svg`;
const sustainabilityInfographicUrl = `${import.meta.env.BASE_URL}media/rapot-sostenibilidad.svg`;
        ...
        <section id="participa" className={`section-frame bg-[#0c3358] py-20 text-white sm:py-28 ${arrivingSection === "participa" ? "is-section-arriving" : ""}`}>
          <div className="mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
            <div data-reveal className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
              <div><p className="eyebrow !text-[#8ec7ef]">07 / Participa</p><h2 className="mt-5 text-4xl font-extrabold leading-[.93] tracking-[-.06em] sm:text-6xl">El nuevo modelo de ciudad también se diseña contigo.</h2><p className="mt-7 max-w-md text-base leading-7 text-[#c3ddec]">Cuéntanos qué necesita tu barrio para ser más cercano, conectado y habitable. Tu respuesta se guarda en este dispositivo como borrador; para recibir respuestas de varios ciudadanos conectaremos después un servicio de formularios.</p><div className="mt-8 grid gap-3 sm:grid-cols-3 lg:grid-cols-1"><a href={infographicUrl} download="rapot-indicadores-urbanos.svg" className="inline-flex items-center justify-center gap-3 border border-[#8ec7ef] px-4 py-3.5 text-center font-mono text-xs font-bold uppercase tracking-[.12em] text-[#f4fbff] transition-colors hover:bg-[#2679c6]"><Download size={16} /> Indicadores</a><a href={mobilityInfographicUrl} download="rapot-movilidad.svg" className="inline-flex items-center justify-center gap-3 border border-[#8ec7ef] px-4 py-3.5 text-center font-mono text-xs font-bold uppercase tracking-[.12em] text-[#f4fbff] transition-colors hover:bg-[#2679c6]"><Download size={16} /> Movilidad</a><a href={sustainabilityInfographicUrl} download="rapot-sostenibilidad.svg" className="inline-flex items-center justify-center gap-3 border border-[#8ec7ef] px-4 py-3.5 text-center font-mono text-xs font-bold uppercase tracking-[.12em] text-[#f4fbff] transition-colors hover:bg-[#2679c6]"><Download size={16} /> Sostenibilidad</a></div></div>
