    ...
    <div className="rapot-shell min-h-screen overflow-x-hidden bg-[#f7f5ee] text-[#1f2623]">
      ...
      <main>
        <section id="inicio" className="hero-section relative isolate flex min-h-[780px] items-end overflow-hidden bg-[#1c2420] pt-20 text-white">
          <img src={heroImage} alt="Placeholder: imagen industrial original pendiente" className="hero-image absolute inset-0 h-full w-full object-cover object-center" />
      ...
      <footer className="site-footer bg-[#1d2422] py-10 text-white"><div className="mx-auto flex max-w-[1440px] flex-col gap-7 px-5 sm:px-8 md:flex-row md:items-end md:justify-between lg:px-12"><div className="flex items-center gap-3"><img src={brandMark} alt="" className="brand-mark h-12 w-12 object-contain" /><div><p className="font-mono text-lg font-bold tracking-[.22em]">RAPOT</p><p className="mt-1 font-mono text-[9px] uppercase tracking-[.14em] text-white/70">Atlas de ciudad / edición inicial</p></div></div><p className="max-w-sm font-mono text-[9px] uppercase leading-5 tracking-[.12em] text-white/70">Una adaptación editorial para explorar los vínculos de un territorio urbano.</p></div></footer>
    </div>
  );
}
